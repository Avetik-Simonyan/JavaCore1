...
public class AuthorBookTest {
    ...
    public static void main(String[] args) {
        ...
        bookStorage.add(new Book("girq", "novel", 100, 5, new
                Author("poxos", "poxosyan", 22, "poxos@mail.com", "male")));
        bookStorage.add(new Book("girq1", "vep", 200, 10, new
                Author("poxosuhi", "poxosyan", 23, "poxouhis@mail.com", "female")));
        bookStorage.add(new Book("girq2", "drama", 300, 15, new
