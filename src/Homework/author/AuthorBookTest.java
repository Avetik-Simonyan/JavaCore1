...
public class AuthorBookTest {
    ...
    private static void printCommands() {
        ...
        System.out.println("please input " + DELETE_BOOK + " input books title for delete books");
        System.out.println("please input " + DELETE_BOOK_BY_AUTHOR + " input authors email for delete all books" + "\u001B[0m");
    }
